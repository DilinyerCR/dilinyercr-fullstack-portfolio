                ...
                <div className="p-8 bg-card rounded-xl shadow-xl border border-gray-100 dark:border-gray-700">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
                        <div>
                            ...
                            />
                            {errors.name && (
                                <p className='text-red-500 text-sm m-3'>{errors.name.message}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            />
                            {errors.email && (
                                <p className='text-red-500 text-sm m-3'>{errors.email.message}</p>
                            )}
                        </div>
                        <div>
                            <label htmlFor="message" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Mensaje</label>
                            <textarea id="message" name="message" rows={4} required className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-primary focus:border-primary dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100"
                                {...register('message', {
                                    required: "El mensaje es obligatorio."
                                })}
                            ></textarea>
                            {errors.message && (
                                <p className='text-red-500 text-sm m-3'>{errors.message.message}</p>
                            )}
                        </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center space-x-4 p-4 bg-card rounded-xl shadow-md border border-gray-100 dark:border-gray-700">
                            ...
                            <div>
                                ...
                                <a href="https://m.me/dilinyer.castillorodriguez" target="_blank" rel="noopener noreferrer" className="font-medium text-text-light dark:text-text-dark hover:text-blue-700 transition duration-300">Mensaje Directo</a>
                            </div>
                        </div>
                    </div>
